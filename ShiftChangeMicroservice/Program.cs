...
builder.Services.AddDbContext<ServiceContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("ShiftChangeRequestServiceConnection")));

// Registrer DAL og service lag interfaces med deres implementeringer
builder.Services.AddScoped<IShiftChangeData, ShiftChangeDataManager>();
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ShiftChange MicroService API", Version = "v1" });
